...
<div class="panel panel-default">
    <div class="panel-heading">Aggregated Stats for last 15 minutes :- Generation <?php echo $typeId;?> </div>
...
<div class="panel panel-default">
    <div class="panel-heading">Aggregated Stats for last 15 minutes :- Distribution <?php echo $typeId;?> </div>
    <div class="panel-body">
    	<table class="table table-striped table-bordered table-hover no-footer" id="apisId" role="grid" aria-describedby="apisId_info">
		    <thead>
		      <tr role="row">

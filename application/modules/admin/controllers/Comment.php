...
class Comment extends MX_Controller {
    ...
    */
        ...
        if ( count( $data ) > 0 ) {
            ...
            */
            foreach ( $data as $val ) {
                ...
                $actionStr = '<a href="'.base_url().'admin/'.$this->controller.'/delete/'.$val->blog_com_id.'" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete</a>';
    ...
    public function delete() {
        $blog_com_id = $this->uri->segment( 4 );
        $this->comment_model->changeStatusDelete( $blog_com_id );

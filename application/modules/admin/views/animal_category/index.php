...
$(document).ready(function() {
    ...
    $("#exampleTable").on("click", ".statusChange", function() {
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Birds Category
            <div class="pull-right"><a href="<?php echo base_url('admin/' . $controller . '/add'); ?>"
                    class="btn btn-info">
                ...
                <tr class="<?php echo $listClass; ?> ">
                    <td><?php if ($value->image_name != '') { ?>
                        <img height="75" width="150"
                            src="<?php echo base_url('uploads/category/' . $value->image_name); ?>">
                        <?php } ?>
                    </td>
                    ...
                    <td>
                        <a class="statusChange btn btn-<?php echo $value->acm_status == 'active' ? 'info' : 'warning'; ?> btn-xs"
                            href="javascript:void(0);" title="Click to change Status"
                            value="<?php echo $value->acm_status == 'active' ? 'unlock' : 'lock'; ?>"
                            id="status_<?php echo $value->acm_id; ?>" name="<?php echo $value->acm_id; ?>"><i
                                id="i_status_<?php echo $value->acm_id; ?>"
                                class="fa fa-<?php echo $value->acm_status == 'active' ? 'unlock' : 'lock'; ?>"></i>
                            <span
                                id="span_status_<?php echo $value->acm_id; ?>"><?php echo ucfirst($value->acm_status); ?></span>
                        </a>
                    </td>

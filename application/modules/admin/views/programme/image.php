                ...
                <form role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 " id="imageDivId">
                            <div id="imageId" width="200" height="100" class=" alert alert-success alert-dismissable">
                        ...
                        <tr class="<?php echo $listClass; ?> ">
                            <td>
                                <div class="col-sm-3">
                                    <img width="200" height="100"
                                        src="<?php echo base_url(); ?><?php echo UPLOAD_PROG_PATH; ?>thumb/<?php echo $value->prog_img_name; ?>"
                                        alt="" />
                                </div>
                            </td>
                            <td>Full Image :
                                <?php echo base_url(); ?><?php echo UPLOAD_PROG_PATH; ?><?php echo $value->prog_img_name; ?><br>
                                Thumbnail Image :
                                <?php echo base_url(); ?><?php echo UPLOAD_PROG_PATH; ?>thumb/<?php echo $value->prog_img_name; ?>
                            </td>
                            <td>
                                <div class="radio">
                                    <label><input type="radio" class="amiDefault" name="ami_default"
                                            value="<?php echo $value->prog_img_id; ?>"
                                            <?php if ($value->is_default == 1) { ?> checked <?php } ?>>
                                    </label>
                                </div>
                            </td>
                            ...
                            <td class="center">
                                <a onclick="return confirm('Are you sure to delete this image?')"
                                    href="<?php echo base_url(); ?>admin/<?php echo $controller; ?>/image_delete/<?php echo $value->prog_img_id; ?>"

...
<body>
    ...
    <section class="pad">
        <div class="container">
            <h4><strong>Steam Shift Wise Report</strong>
            ...
            <div class="row">
                <form name="frmReport" action="" method="post">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="date" class="form-control" name="startDate" id="datepicker" value="<?php echo isset($_POST['startDate']) ? $_POST['startDate'] : '';?>">
                    </div>
                    <div class="col-lg-4">
                    ...
                    <!-- <input type="text" name="endDate" id="datepicker1" value="<?php echo isset($_POST['endDate']) ? $_POST['endDate'] : '';?>"> -->
                    <div class="col-lg-4">

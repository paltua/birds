...
<script type="text/javascript" language="javascript" src="<?php echo base_url();?>resource/fchart/js/themes/fusioncharts.theme.fint.js"></script>
    ...
    function changeSection(sectionname){
        ...
        //alert(sectionname);
        if(sectionname=='air'){
            window.location.href = '<?php echo base_url();?>diy1/reportair';
        }else if(sectionname=='steam'){
            window.location.href = '<?php echo base_url();?>diy1/reportsteam';
        }else if(sectionname=='ems'){
            window.location.href = '<?php echo base_url();?>diy1/reportems';
        }else{
...
<body>
    ...
    <section class="pad">
        <div class="container">
            <h4><strong>Basic Statistical Analysis</strong>
                        ...
                        <div class="col-lg-3">
                            ...
                            <select name="meter" class="form-control" required>
                                ...
                                <?php
                                    ...
                                    ?>
                                    <option value="<?php echo $meterObjvalue->device_id;?>" <?php echo (isset($_POST['meter']) && ($meterObjvalue->device_id==$_POST['meter'])) ? 'selected': '';?>><?php echo $meterObjvalue->device_name;?></option>
                                    <?php }}?>
                            </select>
                        </div>
                        <div class="col-lg-2">

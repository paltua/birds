<?php //echo "<pre>"; print_r($typeWise);print_r($kwhData);
		    	...
		    	<tr role="row" class="odd">
		        	...
		        	<td>
		        		<p>
		        			...
		        			$g_sum['KWH'][] = $kwhVal;
		        			if($kwhVal != 0){?>
			        			<a href="javascript:void(0);" meter-link="<?php echo base_url();?>ems/report/showGraphKwhDay/<?php echo $key;?>/<?php echo $chartDate;?>/<?php echo $chartDateEnd;?>" class="showChart">

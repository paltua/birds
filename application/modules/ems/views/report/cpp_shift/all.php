		    ...
		    <tbody> 
		    	...
		    	<tr role="row" class="odd">
		    		<th style="">
		          	...
		          	<?php if(in_array($valH, $linkArr)){ ?>
		          		<p>
			          		<a href="javascript:void(0);" meter-link="<?php echo base_url();?>ems/report/showGraphCpp/<?php echo $value->device_id;?>/<?php echo $valH;?>/<?php echo $selectedShift;?>/<?php echo $chartDate;?>" class="showChart">
		    	...
		    	<tr role="row">
			      	<th style="">
			      		...
			      		?>
			      			<th style="">
					          <p><a href="javascript:void(0);" meter-link="<?php echo base_url();?>ems/report/showGraphCppTotal/<?php echo $val;?>/<?php echo $selectedShift;?>/<?php echo $chartDate;?>" class="showChart"><?php echo number_format((float)round($showGval,2), 2, '.', '');?></a></p>
					        </th>
			      		<?php } ?>
			    	</tr>
		  	</tbody>

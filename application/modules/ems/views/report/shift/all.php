		    	...
		    	<tr role="row" class="odd">
		    		<th style="">
		          	...
		          	<?php if(in_array($valH, $linkArr)){ ?>
		          		<p>
			          		<a href="javascript:void(0);" meter-link="<?php echo base_url();?>ems/report/showGraph/<?php echo $key;?>/<?php echo $valH;?>/<?php echo $selectedShift;?>/<?php echo $chartDate;?>" class="showChart">
		        	...
		        	<td>
		        		<p>
		        			<?php 
		        			if(isset($kwhData[$key][0]['kwhVal']) && isset($kwhData[$key][1]['kwhVal'])){
		        				$kwhVal = $kwhData[$key][1]['kwhVal'] - $kwhData[$key][0]['kwhVal'];
		        			}else{
		        				$kwhVal = 0;
		        			}
		        			$g_sum['KWH'][] = $kwhVal;
		        			if($kwhVal != 0){?>
			        			<a href="javascript:void(0);" meter-link="<?php echo base_url();?>ems/report/showGraphKwhShift/<?php echo $key;?>/<?php echo $selectedShift;?>/<?php echo $chartDate;?>" class="showChart">
		    	...
		    	<tr role="row">
			      	<th style="">
			      		...
			      		?>
			      			<th style="">
					          <p>
					          	<a href="javascript:void(0);" meter-link="<?php echo base_url();?>ems/report/showGraphTotal/<?php echo $val;?>/G/<?php echo $typeId;?>/<?php echo $selectedShift;?>/<?php echo $chartDate;?>" class="showChart">
			      		...
			      		<?php } ?>
			      		<th style="">
				          	<p><?php echo number_format((float)round(array_sum($g_sum['KWH']),2), 2, '.', '');?></p>
				      	</th>
			    	</tr>
		  	</tbody>
		</table>
		    	...
		    	<tr role="row">
			      	<th style="">
			      		...
			      		?>
			      			<th style="">
					          <p>
					          	<a href="javascript:void(0);" meter-link="<?php echo base_url();?>ems/report/showGraphTotal/<?php echo $val;?>/D/<?php echo $typeId;?>/<?php echo $selectedShift;?>/<?php echo $chartDate;?>" class="showChart">
					          	<?php echo number_format((float)round($showGval,2), 2, '.', '');?>
					          </a>
					          </p>
					        </th>
			      		<?php } ?>
			      		<th style="">
				          	<p><?php echo number_format((float)round(array_sum($d_sum['KWH']),2), 2, '.', '');?></p>
				      	</th>
			    	</tr>
		  	</tbody>
		</table>
...
<div class="panel panel-default">
    <div class="panel-heading">Distribution loss <?php echo $typeId;?></div>
    <div class="panel-body">
    	<table class="table table-striped table-bordered table-hover no-footer" id="apisId" role="grid" aria-describedby="apisId_info">
		    <thead>
		      	<tr role="row">
		    ...
		    <tbody>
		    	<tr role="row" class="odd">
		    		<th style="">
			      	...
			      	<th style="">
			          <p>
			          	<a href="javascript:void(0);" meter-link="<?php echo base_url();?>ems/report/showGraphTotalLoss/<?php echo $typeId;?>/<?php echo $selectedShift;?>/<?php echo $chartDate;?>/abs" class="showChart">
			      	...
			      	<th style="">
			          <p>
			          	<a href="javascript:void(0);" meter-link="<?php echo base_url();?>ems/report/showGraphTotalLoss/<?php echo $typeId;?>/<?php echo $selectedShift;?>/<?php echo $chartDate;?>/per" class="showChart">

...
$headerArrNew = array('Amps','HZ','KW','PF','Volt','KWH');
$g_sum = array();
$d_sum = array();
$g_total = array();
$d_total = array();
    	...
    	<table class="table table-striped table-bordered table-hover no-footer" id="apisId" role="grid" aria-describedby="apisId_info">
		    <thead>
		      ...
		      <th style="">
	      		...
	      		<?php foreach($headerArrNew as $key => $val){ ?>
	      			<th style="">
			          <p><?php echo $val;?></p>
			        </th>
	      		<?php } ?>
		    ...
		    <tbody> 
		      		...
		      		<?php foreach($meterWiseDataCpp as $key => $val){ ?>
				    	<tr role="row" class="odd">
				    		...
				    		<td>
							      ...
							      ?>
				          		<p><a href="javascript:void(0);" class="ppChartShow" meter-link="<?php echo base_url();?>ems/report/showGraphDayCpp/<?php echo $val->device_id;?>/<?php echo $valX;?>/<?php echo $chartDate;?>/<?php echo $chartDateEnd;?>"><?php echo number_format((float)round($val->{$valX},2), 2, '.', '');?></a></p>
				          	</td>
				    		...
				    		<?php }else{?>
				          	...
				          	<td>
				        		<p>
				        			...
				        			if(isset($emsCppKwhData[$val->device_id][0]['kwhVal']) && isset($emsCppKwhData[$val->device_id][1]['kwhVal'])){
				        				$kwhVal = $emsCppKwhData[$val->device_id][1]['kwhVal'] - $emsCppKwhData[$val->device_id][0]['kwhVal'];
				        			}else{
				        				$kwhVal = 0;
				        			}
				        			$cpp_sum['KWH'][] = $kwhVal;
				        			if($kwhVal != 0){?>
					        			<a href="javascript:void(0);" meter-link="<?php echo base_url();?>ems/report/showGraphKwhDayCpp/<?php echo $val->device_id;?>/<?php echo $chartDate;?>/<?php echo $chartDateEnd;?>" class="showChart">
					        				<?php echo number_format((float)round($kwhVal,2), 2, '.', '');?>
					        			</a>
				        			<?php 
				        			}else{
				        				echo number_format((float)round($kwhVal,2), 2, '.', '');
				        			} 
				        			?>
				        		</p>
				        	</td>
		    	...
		    	<?php foreach($headerArr as $keyX => $valX){ $cppData = 0;?>
		        	...
		        	<?php } ?>
		        	<th style="">
			          	<p><?php echo number_format((float)round(array_sum($cpp_sum['KWH']),2), 2, '.', '');?></p>
			      	</th>
    	...
    	<table class="table table-striped table-bordered table-hover no-footer" id="apisId" role="grid" aria-describedby="apisId_info">
		    ...
		    <tbody> 
		    	...
		    	<tr role="row" class="odd">
				    ...
				    <td style="">
				          <p><?php 
				        			if(isset($emsCppKwhData[$ecdlVal->device_id][0]['kwhVal']) && isset($emsCppKwhData[$ecdlVal->device_id][1]['kwhVal'])){
				        				$kwhVal = $emsCppKwhData[$ecdlVal->device_id][1]['kwhVal'] - $emsCppKwhData[$ecdlVal->device_id][0]['kwhVal'];
				        			}else{
				        				$kwhVal = 0;
				        			}
				        			$cpp_sum_kwh[$ecdlKey] = $kwhVal;
				        			if($kwhVal != 0){?>
					        			<a href="javascript:void(0);" meter-link="<?php echo base_url();?>ems/report/showGraphKwhDayCpp/<?php echo $ecdlVal->device_id;?>/<?php echo $chartDate;?>/<?php echo $chartDateEnd;?>" class="showChart">
					        				<?php echo number_format((float)round($kwhVal,2), 2, '.', '');?>
					        			</a>
				        			<?php 
				        			}else{
				    ...
				    <td style="">
				          <p><?php 
				        			if(isset($emsKwhData[$emsDataLoss[$ecdlKey]->device_id][0]['kwhVal']) && isset($emsKwhData[$emsDataLoss[$ecdlKey]->device_id][1]['kwhVal'])){
				        				$wilKwhVal = $emsKwhData[$emsDataLoss[$ecdlKey]->device_id][1]['kwhVal'] - $emsKwhData[$emsDataLoss[$ecdlKey]->device_id][0]['kwhVal'];
				        			}else{
				        				$wilKwhVal = 0;
				        			}
				        			$wil_sum_kwh[$ecdlKey] = $wilKwhVal;
				        			if($wilKwhVal != 0){?>
					        			<a href="javascript:void(0);" meter-link="<?php echo base_url();?>ems/report/showGraphKwhDay/<?php echo $emsDataLoss[$ecdlKey]->device_id;?>/<?php echo $chartDate;?>/<?php echo $chartDateEnd;?>" class="showChart">
					        				<?php echo number_format((float)round($wilKwhVal,2), 2, '.', '');?>
					        			</a>
				        			<?php 
				        			}else{
				        				echo number_format((float)round($wilKwhVal,2), 2, '.', '');
				        			} 
				        			?></p>
				    </td>
				    <td style="">
				    ...
				    <!-- <td style="">
				          <p>
				          	<?php $per_total_kwh = round($cpp_sum_kwh[$ecdlKey] - $wil_sum_kwh[$ecdlKey],2);?>
				          	<?php if($per_total_kwh != 0){?>
				          	<a href="javascript:void(0);" class="ppChartShow" meter-link="<?php echo base_url();?>ems/report/showPPWILchartLoss/<?php echo $ecdlVal->device_id;?>/<?php echo $emsDataLoss[$ecdlKey]->device_id;?>/<?php echo $chartDate;?>/<?php echo $chartDateEnd;?>/abs">
				          	<?php echo number_format((float)round($per_total_kwh,2), 2, '.', '');?>
				          </a>
				          <?php }else{?>
				          	<?php echo number_format((float)round($per_total_kwh,2), 2, '.', '');?>
				          <?php }?>
				    ...
				    <!-- <td style="">
				          <p>
				          	<?php $cpp_sum_kwh_temp[$ecdlKey] = ($cpp_sum_kwh[$ecdlKey] == 0)?0:round(($per_total_kwh/$cpp_sum_kwh[$ecdlKey])*100,2);?>
				          	<?php if($cpp_sum_kwh_temp[$ecdlKey] != 0){?>
				          	<a href="javascript:void(0);" class="ppChartShow" meter-link="<?php echo base_url();?>ems/report/showPPWILchartLoss/<?php echo $ecdlVal->device_id;?>/<?php echo $emsDataLoss[$ecdlKey]->device_id;?>/<?php echo $chartDate;?>/<?php echo $chartDateEnd;?>/per">
				          	<?php echo number_format((float)round($cpp_sum_kwh_temp[$ecdlKey],2), 2, '.', '');?>
				          </a>
				          <?php }else{?>
				            <?php echo number_format((float)round($cpp_sum_kwh_temp[$ecdlKey],2), 2, '.', '');?>
				      	  <?php } ?>
		    	...
		    	<tr role="row" class="odd">
				    ...
				    <td style="">
			          <p>
			          	<!-- <a href="javascript:void(0);" class="ppChartShow" meter-link="<?php echo base_url();?>ems/report/showCppWillChartLossTotalAll/ems_cpp/<?php echo $chartDate;?>/<?php echo $chartDateEnd;?>"> -->
			          		<?php $cpp_total_kwh = array_sum($cpp_sum_kwh);?>
			          	<?php echo number_format((float)round($cpp_total_kwh,2), 2, '.', '');?>
			          <!-- </a> -->
			          </p>
				    </td>
				    <th style="">
				    ...
				    <td style="">
				          <p>
				          	<!-- <a href="javascript:void(0);" class="ppChartShow" meter-link="<?php echo base_url();?>ems/report/showCppWillChartLossTotalAll/ems/<?php echo $chartDate;?>/<?php echo $chartDateEnd;?>"> -->
				          		<?php $wil_total_kwh = array_sum($wil_sum_kwh);?>
				          	<?php echo number_format((float)round($wil_total_kwh,2), 2, '.', '');?>
				          <!-- </a> -->
				          </p>
				    </td>
				    <td style="">
				    ...
				    <!-- <td style="">
				          <p>
				          	<?php $all_total_kwh = round($cpp_total_kwh - $wil_total_kwh,2);?>
				          	<?php if($all_total_kwh != 0){?>
				          	<a href="javascript:void(0);" class="ppChartShow" meter-link="<?php echo base_url();?>ems/report/showCppWillChartLossAll/abs/<?php echo $chartDate;?>/<?php echo $chartDateEnd;?>">
				          <?php echo number_format((float)round($all_total_kwh,2), 2, '.', '');?>
						      </a>
						     <?php }else{?>
						     <?php echo number_format((float)round($all_total_kwh,2), 2, '.', '');?>
						     <?php }?> 
				    ...
				    <!-- <td style="">
				          <p>
				          	<?php $cpp_total_temp_kwh = ($cpp_total_kwh == 0)?0:round(($all_total_kwh/$cpp_total_kwh) * 100,2);?>
				          	<?php if($cpp_total_temp_kwh != 0){?>
				          	<a href="javascript:void(0);" class="ppChartShow" meter-link="<?php echo base_url();?>ems/report/showCppWillChartLossAll/per/<?php echo $chartDate;?>/<?php echo $chartDateEnd;?>">
				          	<?php echo number_format((float)round($cpp_total_temp_kwh,2), 2, '.', '');?>
				          </a>
				          <?php }else{?>
				          	<?php echo number_format((float)round($cpp_total_temp_kwh,2), 2, '.', '');?>
				      	  <?php } ?>

                        ...
                        <div class="col-lg-4 form-group">
                            ...
                            <select class="form-control" name="p_device_id" id="p_device_id">
                                ...
                                <?php if(count($pDevice) > 0){?>
                                    <?php foreach($pDevice as $val){ $selected = '';if($pDeviceSelected == $val->STYLE_ID){ $selected = 'selected';}?>
                                    <option value="<?php echo $val->STYLE_ID;?>" <?php echo $selected;?>><?php echo $val->STYLE;?></option>
                                    <?php }?>
                                <?php }?>    
                            </select>

    	...
    	<table class="table table-striped table-bordered table-hover no-footer" id="apisId" role="grid" aria-describedby="apisId_info">
		    ...
		    <tbody> 
		    	...
		    	<tr role="row" class="odd">
		        	...
		        	<td>
		          		<p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartAllDay/<?php echo $key1;?>/pres/<?php echo strtotime($dateRange['selectedDate']);?>/<?php echo strtotime($dateRange['selectedDateEnd']);?>"><?php echo isset($value1['P_pressure']) ? round($value1['P_pressure'],3) : '0';?></a></p>
		        	</td>
		        	<td>
		          		<p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartAllDay/<?php echo $key1;?>/temp/<?php echo strtotime($dateRange['selectedDate']);?>/<?php echo strtotime($dateRange['selectedDateEnd']);?>"><?php echo isset($value1['T_temp']) ? round($value1['T_temp'],3) : '0';?></a></p>
		        	</td>
		        	<td>
		          		<p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartAllDay/<?php echo $key1;?>/flow/<?php echo strtotime($dateRange['selectedDate']);?>/<?php echo strtotime($dateRange['selectedDateEnd']);?>"><?php echo isset($value1['flow']) ? round($value1['flow'],3) : '0';?></a></p>
		        	</td>
		        	<!-- <td>
		          	<p>

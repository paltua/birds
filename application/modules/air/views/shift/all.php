    	...
    	<table class="table table-striped table-bordered table-hover no-footer" id="apisId" role="grid" aria-describedby="apisId_info">
		    ...
		    <tbody>
		    	...
		    	<tr>
		    		...
		    		<td>
		    			<!-- <a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShift_CPP/<?php echo $cppMkey;?>/pres/<?php echo $shiftVal;?>">
		    			...
		    			?>
		    			<a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShift_CPPforDoubleGraph/<?php echo $cppMkey;?>/pres/<?php echo $shiftVal;?>">
		    		...
		    		<td>
		    			...
		    			<!-- <a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShift_CPP/<?php echo $cppMkey;?>/flow/<?php echo $shiftVal;?>">
		    				<?php echo (isset($cppMvalue['flow']) && $cppMvalue['flow']!=0) ? number_format($cppMvalue['flow'],3) : '--';?>
		    			</a> -->
		    			<?php
		    				if(isset($cppMvalue['flow']) && $cppMvalue['flow']!=0){
		    			?>
		    			<a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShift_CPPforDoubleGraph/<?php echo $cppMkey;?>/flow/<?php echo $shiftVal;?>">
		    				<?php echo (isset($cppMvalue['flow']) && $cppMvalue['flow']!=0) ? number_format($cppMvalue['flow'],3) : '--';?>
		    			</a>
		    			<?php }?>
		    		</td>
		    ...
		    <tbody> 
		    	...
		    	<tr role="row" class="odd">
		        	...
		        	<td>
		        		...
		        		<?php 
		        			...
		        			if(isset($last15DataSet_KW[$key1][0]) && $last15DataSet_KW[$key1][0]!='0' && $last15DataSet_KW[$key1][0]!='DNA'){
		        			?>
		          		  <p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>ems/report/showGraph_Air/<?php echo $last15DataSet_KW[$key1][1];?>/KW/<?php echo $shift_count;?>/<?php echo strtotime($dateRange['selectedDate']);?>/<?php echo $key1;?>"><?php echo $last15DataSet_KW[$key1][0];?></a></p>
		          		  <?php }else{echo 'DNA';}?>

		        	</td>
		        	<?php } ?>
		        	<td>
		          	<!-- <p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShift/<?php echo $key1;?>/pres/<?php echo $shiftVal;?>"><?php echo (isset($value1['P_pressure']) && $value1['P_pressure']>0) ? round($value1['P_pressure'],3) : 'DNA';?></a></p> -->
		          	<?php
		          		if(isset($value1['P_pressure']) && $value1['P_pressure']>0){
		          	?>
		          	<p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShiftForDoubleGraph/<?php echo $key1;?>/pres/<?php echo $shiftVal;?>"><?php echo (isset($value1['P_pressure']) && $value1['P_pressure']>0) ? round($value1['P_pressure'],3) : 'DNA';?></a></p>
		          	<?php }else{echo '0';}?>
		        	...
		        	<td>
		        		...
		        		?>
		          		<p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShift/<?php echo $key1;?>/temp/<?php echo $shiftVal;?>"><?php echo (isset($value1['T_temp']) && $value1['T_temp']>0) ? round($value1['T_temp'],3) : 'DNA';?></a></p>
		          		<?php }else{echo '0';}?>
		        	</td>
		        	<td>
		          	<!-- <p>
		          		<a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShift/<?php echo $key1;?>/flow/<?php echo $shiftVal;?>"><?php echo (isset($value1['flow']) && $value1['flow']>0) ? round($value1['flow'],3) : 'DNA';?></a>
		          		</p> -->
		          		<?php
		          			if(isset($value1['flow']) && $value1['flow']>0){
		          		?>
		          		<p>
		          		<a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShiftForDoubleGraph/<?php echo $key1;?>/flow/<?php echo $shiftVal;?>"><?php echo (isset($value1['flow']) && $value1['flow']>0) ? round($value1['flow'],3) : 'DNA';?></a>
		          		</p>
		          		<?php }else{echo '0';}?>
		        	</td>
		        	<?php if($key == 'gen'){?>
		        	<td>
		          		<p>
		          			<?php //echo ($value1['flow']>0) ? number_format(($last15DataSet_KW[$key1][0] / $value1['flow']),3) : '0';?>
		          				...
		          				<?php 
		          					...
		          					if($value1['flow']>0){
		          					?>
		          			  <a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChart_forKWCFM_shift/<?php echo $key1;?>/<?php echo strtotime($dateRange['selectedDate']);?>/<?php echo $shift_count;?>"><?php echo ($value1['flow']>0) ? number_format(($last15DataSet_KW[$key1][0] / $value1['flow']),3) : '0';?></a>
		          			  <?php }else{echo '0';}?>
		        	...
		        	<td>
		          		<p>
		          			...
		          			<?php 
	          			 	...
	          			 	?>
		          			 		<a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShiftFORCFMCU_percent/<?php echo $key1;?>/flow/<?php echo $shiftVal;?>">
		        	...
		        	<!-- <td>
		        	 ...
		        	 <td>
		          		...
		          		<?php
		          			...
		          			if($TTL_flowVal>0){
		          				$TTL_flowVal = round((($TTL_flowVal/1440)),3);
			          			$totaliserTotal+= $TTL_flowVal;

			          			if(isset($value1['flow']) && isset($TTL_flowVal) && ($TTL_flowVal>=($value1['flow']*0.9)) && ($TTL_flowVal<=($value1['flow']*1.1))){
			          				//echo $TTL_flowVal;
			          			?>
			          				<a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShiftForTotaliser/<?php echo $key1;?>/totaliser/<?php echo $shiftVal;?>"><?php echo $TTL_flowVal;?></a>
			          			<?php
			          			}else{
			          			...
			          			?>
			          				<a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShiftForTotaliser/<?php echo $key1;?>/totaliser/<?php echo $shiftVal;?>" data-toggle="tooltip" style="color:red;" title="Possible error, as the totaliser value does n't lie between +- 10% of the average flow value"><?php echo $TTL_flowVal;?></a>
			          			<?php
			          			}
			          		}else{
			          			echo 'DNA';
					...
					<tr role="row" class="odd">
			        	...
			        	<td >
			          		...
			          		<p><?php if($keyNcm == 11){ echo 'N/A';}else{ ?>
			          			...
			          			<?php
			          				if(isset($last15DataSet_KW[$keyNcm][0]) && $last15DataSet_KW[$keyNcm][0]!='0' && $last15DataSet_KW[$keyNcm][0]!='DNA'){
			          				?>
			          			<p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>ems/report/showGraph_Air/<?php echo $last15DataSet_KW[$keyNcm][1];?>/KW/<?php echo $shift_count;?>/<?php echo strtotime($dateRange['selectedDate']);?>/<?php echo $keyNcm;?>"><?php echo $last15DataSet_KW[$keyNcm][0];?></a></p>
			          			<?php }else{echo 'DNA';}?>
		    	...
		    	<tr role="row" class="even">
		        	...
		        	<td>
		          		...
		          		<p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartKWTotal_shift/<?php echo strtotime($dateRange['selectedDate']);?>/<?php echo $shift_count;?>"><?php echo (isset($compRelKW_total)) ? round($compRelKW_total,3) : '0';?></a></p>
		        	...
		        	<td>
		          	...
		          	<!-- <p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShiftTotal/pres/<?php echo $key;?>/<?php echo $shiftVal;?>"><?php echo isset($typeWise[$key]['total']['P_pressure']) ? round($typeWise[$key]['total']['P_pressure'],3) : '0';?></a></p> -->

		          	<p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShiftTotalforDoubleGraph/pres/<?php echo $key;?>/<?php echo $shiftVal;?>"><?php echo isset($typeWise[$key]['total']['P_pressure']) ? round($typeWise[$key]['total']['P_pressure'],3) : '0';?></a></p>

		        	</td>
		        	<td>
		          	<!-- <p><?php //echo isset($typeWise[$key]['total']['T_temp']) ? round($typeWise[$key]['total']['T_temp'],3) : '0';?></p> -->

		          	<p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShiftTotal/temp/<?php echo $key;?>/<?php echo $shiftVal;?>"><?php echo isset($typeWise[$key]['total']['T_temp']) ? round($typeWise[$key]['total']['T_temp'],3) : '0';?></a></p>

		        	</td>
		        	<td>
		          	<!-- <p><?php //echo isset($typeWise[$key]['total']['flow']) ? round($typeWise[$key]['total']['flow'],3) : '0';?></p> -->

		          	<!-- <p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShiftTotal/flow/<?php echo $key;?>/<?php echo $shiftVal;?>"><?php echo isset($typeWise[$key]['total']['flow']) ? round($typeWise[$key]['total']['flow'],3) : '0';?></a></p> -->

		          	<p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShiftTotalforDoubleGraph/flow/<?php echo $key;?>/<?php echo $shiftVal;?>"><?php echo isset($typeWise[$key]['total']['flow']) ? round($typeWise[$key]['total']['flow'],3) : '0';?></a></p>
		          			...
		          			<?php 
		          				if(isset($typeWise[$key]['total']['TTL_flow'])){
		          					if($typeWise[$key]['total']['TTL_flow']>=0){
		          						echo round($typeWise[$key]['total']['TTL_flow'] / 480,3);
		          					}else{
		          						echo 'Error';
		          					}
		          				}else{
		          		...
		          		<?php		          		
		          			if(isset($totaliserTotal) && $totaliserTotal>0){
			          			if(isset($typeWise[$key]['total']['flow']) && isset($totaliserTotal) && ($totaliserTotal>=($typeWise[$key]['total']['flow']*0.9)) && ($totaliserTotal<=($typeWise[$key]['total']['flow']*1.1))){
			          				...
			          				//echo "<span style='color:red;'>".$totaliserTotal."</span>";
    	...
    	<table class="table table-striped table-bordered table-hover no-footer" id="apisId" role="grid" aria-describedby="apisId_info">
		    ...
		    <tbody> 
		    	...
		    	<tr role="row" class="even">
		        	...
		        	<td>
		        		<!-- <a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartTotalGNvsDIST/pres/<?php echo $shiftVal;?>"> -->

		        		<a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartTotalGNvsDISTforDoubleGraph/pres/<?php echo $shiftVal;?>">
			          	<p><?php 
		        	...
		        	<td>
		        		<!-- <a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartTotalGNvsDIST/flow/<?php echo $shiftVal;?>"> -->

		        		<a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartTotalGNvsDISTforDoubleGraph/flow/<?php echo $shiftVal;?>">
			          	<p><?php 
    	...
    	<table class="table table-striped table-bordered table-hover no-footer" id="apisId" role="grid" aria-describedby="apisId_info">
		    ...
		    <tbody> 
		    	...
		    	<?php foreach ($typeWise['dist']['meter'] as $key2 => $value2) {
		    			...
		    			$viewPressure = 0;
		    			if(isset($typeWise['gen']['total']['P_pressure']) && $typeWise['gen']['total']['P_pressure']>0 && isset($value2['P_pressure']) && $value2['P_pressure']>0){
		    	...
		    	<tr role="row" class="odd">
		        	...
		        	<td>
		        		<?php
		        			if(isset($viewPressure) && $viewPressure!=0 && $viewPressure!='DNA'){
		        		?>
		          	<p><a href="javascript:void(0);" data-toggle="tooltip" class="showChart" meter-link="<?php echo base_url();?>air/report/getMeterChartShift/<?php echo $key2;?>/pres/<?php echo $viewPressure;?>/<?php echo isset($typeWise['gen']['total']['P_pressure']) ? $typeWise['gen']['total']['P_pressure'] : '0';?>/<?php echo isset($value2['benchmark_delta_pressure']) ? $value2['benchmark_delta_pressure'] : '0';?>/<?php echo $shiftVal;?>" title="Baseline : <?php echo $value2['benchmark_delta_pressure'];?>"><?php echo $viewPressure;?></a> </p>
		          		<?php }else{echo 'DNA';}?>
		        	</td>
		        	<td>
		        	...
		        	<!-- <td>
		          	<p><a href="javascript:void(0);" class="showChart" meter-link="<?php //echo base_url();?>fm/report/getMeterChartShift/<?php //echo $key2;?>/temp/<?php //echo $viewTemp;?>/<?php //echo isset($typeWise['gen']['total']['T_temp']) ? $typeWise['gen']['total']['T_temp'] : '0';?>/<?php //echo isset($value2['benchmark_delta_temp']) ? $value2['benchmark_delta_temp'] : '0';?>/<?php //echo $shiftVal;?>"><?php echo $viewTemp;?></a> </p>
		        	</td> -->
		        	<!-- <td>

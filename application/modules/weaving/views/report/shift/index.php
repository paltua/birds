...
<body>
    ...
    <section class="pad">
        <div class="container">
            ...
            <h4><strong>Weaving Shift wise Report</strong> 
            ...
            <form name="frmReport" action="" method="post">
                ...
                <div class="col-lg-4">
                        ...
                        <input class="form-control" name="selectedDate" id="datepicker" value="<?php echo $selectedDate;?>" type="date" max="<?php echo date('Y-m-d');?>">

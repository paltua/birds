...
<div class="panel panel-default">
    <div class="panel-heading"> Compressed Air Stats:- <?php echo ($key == 'gen')?'Generation':'Distribution';?></div>
		        	...
		        	<td>
		          		...
		          		?>
			          		...
			          		Analysis : <?php 
			          			...
			          			$expTem = explode('_', $value1['meter']['P_pressure']['calculated']['analysis']);
			          			$analysisTemp = implode(' ', $expTem);
		        	...
		        	<td>
	          			...
	          			?>
			          		...
			          		Analysis : <?php 
			          			...
			          			$expTem = explode('_', $value1['meter']['T_temp']['calculated']['analysis']);
			          			$analysisTemp = implode(' ', $expTem);
		        	...
		        	<td>
	          			...
	          			?>
			          		...
			          		Analysis : <?php 
			          			...
			          			$expTem = explode('_', $value1['meter']['flow']['calculated']['analysis']);
			          			$analysisTemp = implode(' ', $expTem);

...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <table class="table table-striped table-bordered table-hover no-footer" id="apisId" role="grid" aria-describedby="apisId_info">
            ...
            $last15Result0 = round($last15DataSet[0]->total_data, 2);
            $last15Result1 = round($last15DataSet[1]->total_data, 2);
            ?>
            <tbody> 
                <tr role="row" class="odd">
                    ...
                    <th style="">
                        <p><?php echo round($monthlyDataSet[0]->total_data, 2);?></p>
                    </th>
                </tr>
                <tr role="row" class="odd">
                    <th style="">
                    ...
                    <th style="">
                        <p><?php echo round($monthlyDataSet[1]->total_data, 2);?></p>
                    </th>
                </tr>
                <tr role="row" class="odd">
                    <th style="">

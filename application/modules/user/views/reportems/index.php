            ...
            <div class="row">
                ...
                <form name="frmReport" action="" method="post">
                    ...
                    <div class="col-lg-2">
                        ...
                        <input type="date" required name="startDate" max="" value="<?php echo $startDate;?>" class="form-control">
                        
                    </div>
                    <div class="col-lg-2">
                        <label for="email">End Date :</label>
                        <input type="date" required name="endDate" value="<?php echo $endDate;?>" max="" class="form-control">
                    </div>

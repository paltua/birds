...
<body>
    ...
    <section class="pad">
        <div class="container">
            <h4><strong>CPP Day Wise Report </strong> 
                <a href="<?php echo base_url();?>ems/dashboard" style="float: right;;" class="btn btn-primary blbtn">Back</a> <span style="float: right;">&nbsp;</span> <a href="<?php echo base_url();?>ems/report/cppShift/" style="float: right;;" class="btn btn-primary blbtn">Shift Report</a>
            </h4>
            <br/>
            <div class="row">

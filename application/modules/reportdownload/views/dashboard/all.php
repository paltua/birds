...
<div class="panel panel-default">
    <div class="panel-heading">Aggregated Stats for last 15 minutes:- <?php echo ($key == 'gen')?'Generation':'Distribution';?> </div>
    	...
    	<table class="table table-striped table-bordered table-hover no-footer" id="apisId" role="grid" aria-describedby="apisId_info">
		    ...
		    <tbody> 
		    	...
		    	<tr role="row" class="odd">
		        	...
		        	<td>
		          		<p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/dashboard/getMeterChart/<?php echo $key1;?>/pres"><?php echo isset($value1['P_pressure']) ?round($value1['P_pressure'],3) : '0';?></a></p>
		        	</td>
		        	<!-- <td>
		          		<p><?php //echo isset($value1['alert_counter_pressure']) ? $value1['alert_counter_pressure'] : 0;?></p>
		        	</td> -->
		        	<td>
		          		<p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/dashboard/getMeterChart/<?php echo $key1;?>/temp"><?php echo isset($value1['T_temp']) ? round($value1['T_temp'],3) : 0;?></a></p>
		        	</td>
		        	<!-- <td>
		          		<p><?php //echo isset($value1['alert_counter_temp']) ? $value1['alert_counter_temp'] : 0;?></p>
		        	</td> -->
		        	<td>
		          		<p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/dashboard/getMeterChart/<?php echo $key1;?>/flow"><?php echo isset($value1['flow']) ? round($value1['flow'],3) : '0';?></a></p>
		        	</td>
		        	<!-- <td>
		          	<p>
		        	...
		        	<!-- <td>
		          		<p title="<?php //echo isset($value1['TTL_flow']) ? round($value1['TTL_flow'],3) : '0';?>"><?php 
		          			//echo isset($value1['TTL_flow']) ? round($value1['TTL_flow'],3) : '0';
		          			/*if(isset($value1['TTL_flow'])){
		          				if($value1['TTL_flow']>=0){
		          					echo round($value1['TTL_flow'],3);
		          				}else{
		          					echo 'Error';
		          				}
		          			}else{	
    	...
    	<table class="table table-striped table-bordered table-hover no-footer" id="apisId" role="grid" aria-describedby="apisId_info">
		    ...
		    <tbody> 
		    	...
		    	<tr role="row" class="odd">
		        	...
		        	<td>
		          	<p><a href="javascript:void(0);" class="showChart" meter-link="<?php echo base_url();?>air/dashboard/getMeterChart/<?php echo $key2;?>/pres/<?php echo $viewPressure;?>/<?php echo isset($typeWise['gen']['total']['P_pressure']) ? $typeWise['gen']['total']['P_pressure'] : '0';?>/<?php echo isset($value2['benchmark_delta_pressure']) ? $value2['benchmark_delta_pressure'] : '0';?>"><?php echo $viewPressure;?></a> </p>
		        	</td>
		        	<td>

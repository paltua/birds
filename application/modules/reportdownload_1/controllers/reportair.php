				...
				foreach ($datevalue as $typekey => $typevalue) {
					foreach ($typevalue['meter'] as $meterkey => $metervalue) {
						if(isset($metervalue['name'])){
							...
							//$newStrucArray[$i][] = isset($metervalue['TTL_flow']) ? number_format(($metervalue['TTL_flow'] / 1440),3) : '--';
					...
					if($typekey=="gen"){
						...
						$totalGen[$typekey] = isset($typevalue['total']['TTL_flow']) ? ($typevalue['total']['TTL_flow']/1440) : 0;
					...
					if($typekey=="dist"){
						...
						$totalConsumption[$typekey] = isset($typevalue['total']['TTL_flow']) ? ($typevalue['total']['TTL_flow']/1440) : 0;

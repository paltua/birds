					...
					foreach ($value123 as $key => $value) {
						foreach ($value as $key1 => $value1) {
							foreach ($value1['meter'] as $key2 => $value2) {
								...
								if(isset($value2['KW']) && $value2['KW']>0){
									$newArray[$key2]['KW'][$key] = $value2['KW'];
								}
								if(isset($value2['PF']) && $value2['PF']>0){
									$newArray[$key2]['PF'][$key] = $value2['PF'];
								}
								if(isset($value2['Amps']) && $value2['Amps']>0){
									$newArray[$key2]['Amps'][$key] = $value2['Amps'];
								}
								if(isset($value2['Volt']) && $value2['Volt']>0){
									$newArray[$key2]['Volt'][$key] = $value2['Volt'];
								}
								if(isset($value2['HZ']) && $value2['HZ']>0){
			...
			if(count($newArray1)>0){
				foreach ($newArray1 as $meterId => $metervalue) {
					...
					if(isset($metervalue['KW']) && count($metervalue['KW'])>0){
						...
						$arrKWaddiInfo = array("data_key" => "KW","given_high" => "","given_low" => "", "running_info" => array());
						...
						if(isset($kwApiDataJsonDecode['status']) && $kwApiDataJsonDecode['status']=='SUCCESS' && isset($kwApiDataJsonDecode['data'])){
							$resultArray[$metervalue['type']][$meterId]['meter']['KW'] = $kwApiDataJsonDecode['data'];
						}
					...
					if(isset($metervalue['PF']) && count($metervalue['PF'])>0){
						...
						$arrPFaddiInfo = array("data_key" => "PF","given_high" => "","given_low" => "", "running_info" => array());
						...
						if(isset($pfApiDataJsonDecode['status']) && $pfApiDataJsonDecode['status']=='SUCCESS' && isset($pfApiDataJsonDecode['data'])){
							$resultArray[$metervalue['type']][$meterId]['meter']['PF'] = $pfApiDataJsonDecode['data'];
						}
					...
					if(isset($metervalue['Volt']) && count($metervalue['Volt'])>0){
						...
						$arrVOLTaddiInfo = array("data_key" => "Volt","given_high" => "","given_low" => "", "running_info" => array());
						...
						if(isset($VoltApiDataJsonDecode['status']) && $VoltApiDataJsonDecode['status']=='SUCCESS' && isset($VoltApiDataJsonDecode['data'])){
							$resultArray[$metervalue['type']][$meterId]['meter']['Volt'] = $VoltApiDataJsonDecode['data'];
						}
					...
					if(isset($metervalue['Amps']) && count($metervalue['Amps'])>0){
						...
						$arrAMPSaddiInfo = array("data_key" => "Amps","given_high" => "","given_low" => "", "running_info" => array());
						...
						if(isset($AmpsApiDataJsonDecode['status']) && $AmpsApiDataJsonDecode['status']=='SUCCESS' && isset($AmpsApiDataJsonDecode['data'])){
							$resultArray[$metervalue['type']][$meterId]['meter']['Amps'] = $AmpsApiDataJsonDecode['data'];
						}
					...
					if(isset($metervalue['HZ']) && count($metervalue['HZ'])>0){
						...
						$arrHZaddiInfo = array("data_key" => "HZ","given_high" => "","given_low" => "", "running_info" => array());
						...
						if(isset($HZApiDataJsonDecode['status']) && $HZApiDataJsonDecode['status']=='SUCCESS' && isset($HZApiDataJsonDecode['data'])){
							$resultArray[$metervalue['type']][$meterId]['meter']['HZ'] = $HZApiDataJsonDecode['data'];
						}

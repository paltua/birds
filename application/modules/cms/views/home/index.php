            ...
            <div class="two-grid secleft">
                <div class="img-grid clearfix">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo base_url('uploads/gallery/thumb/'.$value->g_path);?>" data-toggle="lightbox" data-gallery="example-gallery"><img src="<?php echo base_url('uploads/gallery/thumb/'.$value->g_path);?>" alt="" class="img-fluid"/></a></li>
                        <?php }?>
                    </ul>
                    <?php } ?>
                </div>

        ...
        <table class="table table-striped table-bordered table-hover no-footer" id="apisId" role="grid" aria-describedby="apisId_info">
            ...
            <tbody> 
                <tr role="row" class="odd">
                    ...
                    <th style="">
                        <p><?php echo (isset($last15DataSet[0]->total_flow))?round($last15DataSet[0]->total_flow, 2):0;?></p>
                    </th>
                    <th style="">
                ...
                <tr role="row" class="odd">
                    ...
                    <th style="">
                        <p><?php echo (isset($last15DataSet[1]->total_flow))?round($last15DataSet[1]->total_flow, 2):0;?></p>
                    </th>
                    <th style="">

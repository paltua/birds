...
<body>
    ...
    <section class="pad">
        <div class="container">
            ...
            <h4><strong> Notification for Meter Error of EMS on <?php echo date("F j, Y", (strtotime('-1 day', strtotime(date('Y-m-d')))));?></strong>
            ...
            <div id="allDataId">
                <table id="example" class="table table-striped table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php if(count($list) > 0){?>
                        <?php foreach($list as $meterVal){ //if($meterVal->HZ == 0 && $meterVal->Volt == 0) continue;?>
                        <tr>

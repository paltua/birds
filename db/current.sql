...
CREATE TABLE `birds`.`comments` ( `com_id` INT NOT NULL AUTO_INCREMENT , `com_parent_id` INT NOT NULL , `comments` LONGTEXT NOT NULL , `user_id` INT NOT NULL , `am_id` INT NOT NULL , `com_status` ENUM('active','inactive') NOT NULL DEFAULT 'active' , `created_date` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , PRIMARY KEY (`com_id`)) ENGINE = InnoDB;
